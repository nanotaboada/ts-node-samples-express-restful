...
- Abstracted: the data access layer should be swappable without touching business logic (see ADR-001)
...
- SQLite's lightweight footprint makes it practical to run tests against the real database (see ADR-006)
